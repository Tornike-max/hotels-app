  ...
  return (
    <div className="w-full h-screen mx-auto bg-black ">
      <div className="flex h-full flex-row flex-wrap ">
        <aside className="w-full sm:w-1/3 md:w-1/4 border-r-[1px] border-gray-700 ">
          <div className="sticky top-0 py-4 px-2 w-full ">
            ...
            <ul className="flex flex-col py-10 gap-6 text-md sm:text-xl md:text-2xl overflow-hidden h-full">
              {paths.map((link, i) => (
